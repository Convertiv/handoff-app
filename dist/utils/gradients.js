...
function getGradientAngle(handles) {
    ...
    var normalizedDirectionGuidePoint = (0, math_1.rotate)(pivotPoint, directionGuidePoint, refAngle);
    var normalizedAngleGuidePoint = (0, math_1.rotate)(pivotPoint, angleGuidePoint, refAngle);
...
function getLinearGradientParamsFromGradientObject(gradient) {
    ...
    var topLineIntersection = (0, math_1.getIntersection)(rotatedTopLine[0], rotatedTopLine[1], scaledArbGradientLine[0], scaledArbGradientLine[1]);
    var bottomLineIntersection = (0, math_1.getIntersection)(rotatedBottomLine[0], rotatedBottomLine[1], scaledArbGradientLine[0], scaledArbGradientLine[1]);
