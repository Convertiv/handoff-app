...
function snippetTransformer(handoff) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const custom = path_1.default.resolve(handoff.workingPath, `integration/snippets`);
        const publicPath = path_1.default.resolve(handoff.workingPath, `public/snippets`);
        ...
        if (fs_extra_1.default.existsSync(custom)) {
            console.log(chalk_1.default.green(`Rendering Snippet Previews in ${custom}`));
            ...
            for (const file of files) {
                ...
                if (file.endsWith('.html')) {
                    data = yield processSnippet(handoff, file, sharedStyles);
                    // Write the API file
                        ...
                        if (semver_1.default.valid(versionDirectory)) {
                            ...
                            for (const versionFile of versionFiles) {
                                ...
                                if (versionFile.endsWith('.html')) {
                                    data = yield processSnippet(handoff, versionFile, sharedStyles, path_1.default.join(file, versionDirectory));
...
function renameSnippet(handoff, source, destination) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ['html', 'js', 'scss', 'css'].forEach((ext) => __awaiter(this, void 0, void 0, function* () {
...
function processSnippet(handoff, file, sharedStyles, sub) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(chalk_1.default.green(`Processing snippet ${file}`));
        if (!sub)
            sub = '';
        const custom = path_1.default.resolve(handoff.workingPath, `integration/snippets`, sub);
        const publicPath = path_1.default.resolve(handoff.workingPath, `public/api/component`);
