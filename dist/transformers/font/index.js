 ...
 */
export default function fontTransformer(handoff, documentationObject) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            outputFolder = 'public';
            fontLocation = path.join(handoff === null || handoff === void 0 ? void 0 : handoff.workingPath, 'fonts');
            ...
            Object.keys(families).map(function (key) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            fontsFolder = path.resolve(handoff.workingPath, handoff.exportsDirectory, handoff.config.figma_project_id, 'integration', 'fonts');
