...
var transformTokens = function (tokens, tokenType, component, part, options) {
    return tokens ? Object.entries(tokens).reduce(function (record, _a) {
        ...
        return (__assign(__assign({}, record), (_b = {}, _b[(0, utils_1.formatTokenName)(tokenType, component, part, property, options)] = {
            ...
            property: property,
            part: part,
            metadata: __assign(__assign({}, (0, utils_1.getTokenMetadata)(component, part, options)), { propertyPath: (0, utils_1.getReducedTokenPropertyPath)(component, part, property, options), isSupportedCssProperty: value instanceof Array ? value[1] : true })
        }, _b)));
    }, {}) : {};
};
