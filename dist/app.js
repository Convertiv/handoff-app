            ...
            if (subFile.endsWith('.mdx')) {
              ...
              for (const thirdFile of thirdFiles) {
                if (thirdFile.endsWith('.mdx')) {
                  ...
                  transformMdx(
                    path_1.default.resolve(pages, file, subFile, thirdFile),
                    path_1.default.resolve(appPath, 'pages', file, subFile, thirdFile),
                    file
                  );
                }
              }
...
const publishTokensApi = (handoff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const type in tokens) {
      ...
      for (const group in tokens[type]) {
        fs_extra_1.default.writeFileSync(
          path_1.default.join(apiPath, 'tokens', `${group}.json`),
          JSON.stringify(tokens[type][group], null, 2)
        );
      }
    }
  });
const prepareProjectApp = (handoff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
...
const persistRuntimeCache = (handoff) => {
  ...
  fs_extra_1.default.writeFileSync(
    destination,
    JSON.stringify(Object.assign({ config: (0, config_1.getClientConfig)(handoff) }, handoff.integrationObject), null, 2),
    'utf-8'
  );
};
/**
 ...
 * @returns
 */
const buildApp = (handoff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (
      !fs_extra_1.default.existsSync(
        path_1.default.resolve(handoff.workingPath, handoff.exportsDirectory, handoff.config.figma_project_id, 'tokens.json')
      )
    ) {
...
const watchApp = (handoff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (fs_extra_1.default.existsSync(path_1.default.resolve(handoff.workingPath, 'exportables'))) {
      chokidar_1.default.watch(path_1.default.resolve(handoff.workingPath, 'exportables'), chokidarConfig).on('all', (event, path) =>
        __awaiter(void 0, void 0, void 0, function* () {
          switch (event) {
            case 'add':
            case 'change':
    ...
    if (fs_extra_1.default.existsSync(path_1.default.resolve(handoff.workingPath, 'public'))) {
      chokidar_1.default.watch(path_1.default.resolve(handoff.workingPath, 'public'), chokidarConfig).on('all', (event, path) =>
        __awaiter(void 0, void 0, void 0, function* () {
          switch (event) {
            case 'add':
            case 'change':
    ...
    const watchRuntimeComponents = (runtimeComponentPathsToWatch) => {
      ...
      if (runtimeComponentPathsToWatch.size > 0) {
        ...
        runtimeComponentsWatcher.on('all', (event, file) =>
          __awaiter(void 0, void 0, void 0, function* () {
    ...
    const watchRuntimeConfiguration = () => {
      ...
      if (handoff.getConfigFilePaths().length > 0) {
        ...
        runtimeConfigurationWatcher.on('all', (event, file) =>
          __awaiter(void 0, void 0, void 0, function* () {
            switch (event) {
              case 'add':
              case 'change':
    ...
    const getRuntimeComponentsPathsToWatch = () => {
      ...
      for (const runtimeComponentId of Object.keys(
        (_b = (_a = handoff.integrationObject) === null || _a === void 0 ? void 0 : _a.entries.components) !== null && _b !== void 0
          ? _b
          : {}
      )) {
        for (const runtimeComponentVersion of Object.keys(handoff.integrationObject.entries.components[runtimeComponentId])) {
          ...
          for (const [runtimeComponentEntryType, runtimeComponentEntryPath] of Object.entries(
            (_c = runtimeComponent.entries) !== null && _c !== void 0 ? _c : {}
          )) {
    ...
    watchRuntimeConfiguration();
    if (
      ((_e = (_d = handoff.integrationObject) === null || _d === void 0 ? void 0 : _d.entries) === null || _e === void 0
        ? void 0
        : _e.integration) &&
      fs_extra_1.default.existsSync(
        (_g = (_f = handoff.integrationObject) === null || _f === void 0 ? void 0 : _f.entries) === null || _g === void 0
          ? void 0
          : _g.integration
      )
    ) {
      ...
      chokidar_1.default
        .watch(
          stat.isDirectory()
            ? handoff.integrationObject.entries.integration
            : path_1.default.dirname(handoff.integrationObject.entries.integration),
          chokidarConfig
        )
        .on('all', (event, file) =>
          __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (fs_extra_1.default.existsSync(path_1.default.resolve(handoff.workingPath, 'pages'))) {
      chokidar_1.default.watch(path_1.default.resolve(handoff.workingPath, 'pages'), chokidarConfig).on('all', (event, path) =>
        __awaiter(void 0, void 0, void 0, function* () {
          switch (event) {
            case 'add':
            case 'change':
