...
const prepareProjectApp = (handoff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handoffIntegrationPath = path_1.default.resolve(
      handoff.workingPath,
      (_c = handoff.config.integrationPath) !== null && _c !== void 0 ? _c : 'integration'
    );
...
const watchApp = (handoff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getRuntimeComponentsPathsToWatch = () => {
      ...
      for (const runtimeComponentId of Object.keys(
        ...
        for (const runtimeComponentVersion of Object.keys(handoff.integrationObject.entries.components[runtimeComponentId])) {
          ...
          for (const [_, runtimeComponentEntryPath] of Object.entries(
    ...
    watchRuntimeConfiguration();
    if (
      ((_f = (_e = handoff.integrationObject) === null || _e === void 0 ? void 0 : _e.entries) === null || _f === void 0
        ? void 0
        : _f.integration) &&
      fs_extra_1.default.existsSync(
        (_h = (_g = handoff.integrationObject) === null || _g === void 0 ? void 0 : _g.entries) === null || _h === void 0
          ? void 0
          : _h.integration
      )
    ) {
