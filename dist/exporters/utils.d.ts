...
export declare function filterByNodeType<Type extends FigmaTypes.Node['type']>(type: Type): (obj?: FigmaTypes.Node | null) => obj is Extract<FigmaTypes.ComponentSet, {
    type: Type;
...
export declare const isValidNodeType: (type: string) => type is "TEXT" | "COMPONENT_SET" | "COMPONENT" | "DOCUMENT" | "CANVAS" | "FRAME" | "GROUP" | "VECTOR" | "BOOLEAN_OPERATION" | "STAR" | "LINE" | "ELLIPSE" | "REGULAR_POLYGON" | "RECTANGLE" | "SLICE" | "INSTANCE";
