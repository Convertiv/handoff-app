...
export function getComponentInstanceNamePart(componentInstanceName, partKey) {
    var _a;
...
export function extractComponentInstanceVariantProps(componentInstanceName, supportedVariantProps) {
    ...
    supportedVariantPropNames.forEach(function (supportedVariantPropName) {
        componentVariantProps.set(supportedVariantPropName, normalizeNamePart(getComponentInstanceNamePart(componentInstanceName, supportedVariantPropName)));
    });
