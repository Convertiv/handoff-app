...
export const DOCS_ASSISTANT_PROMPT = [
  ...
  'then read the record with handoff_get_component or handoff_get_page. For one component state, pass',
  'its preview id from handoff_get_component to handoff_get_component_preview. Take colors, typography',
  'and spacing from handoff_get_tokens.',
  '',
