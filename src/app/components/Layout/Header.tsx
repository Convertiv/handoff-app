...
import { AiAssistantTrigger } from '../../components/AiAssistant/AiAssistantProvider';
...
export function Header() {
  ...
  return (
    <div
      className={cn(
        'h-17 sticky top-0 z-50 py-4 shadow-[0_0_3px_0_rgba(0,0,0,0.15)] backdrop-blur-sm transition-all duration-300',
