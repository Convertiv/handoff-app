/**
 * The Model Context Protocol mark. Path from Simple Icons (`modelcontextprotocol`), CC0-1.0.
 *
 * Unlike the stroked lucide icons around it this is a filled path, so it takes `fill`, not `stroke`.
 */
