...
import { ArrowRightToLine, Check, Contrast, Link, SwatchBook } from 'lucide-react';
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <Breadcrumb>
              <BreadcrumbList className="text-xs text-gray-500">
                {['bread1', 'bread2', 'bread3'].map((group, index) => (
                  <BreadcrumbItem key={group}>
                    <BreadcrumbPage className="text-gray-500">{group}</BreadcrumbPage>
                    {2 !== index && <BreadcrumbSeparator>/</BreadcrumbSeparator>}
                  </BreadcrumbItem>
                ))}
              </BreadcrumbList>
            </Breadcrumb>
