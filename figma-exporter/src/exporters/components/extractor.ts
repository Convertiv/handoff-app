...
function mergeTokenSets(first: ExportTypes.TokenSet, second: ExportTypes.TokenSet) : ExportTypes.TokenSet {
  return _.mergeWith({}, first, second,
    (a, b) => b === null ? a : undefined
  )
}

function getComponentSupportedVariantProperties(definition: ExportableDefinition): { property: VariantProperty, params: string[] | null }[] {
